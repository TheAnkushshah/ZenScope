...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-[#e9eeea]">
          ...
          <a href="/" className="flex items-center gap-3 hover:opacity-80 transition-opacity">
            ...
            <div className="relative">
              <h1 className="text-xl font-light tracking-wide text-[#3c4f3d]">
                ...
                <span className="text-[#de8246]">scope</span>
              </h1>
            </div>
          </a>
      ...
      <footer className="container mx-auto px-6 pt-4 flex flex-col items-center justify-center text-center space-y-5 pb-9">
  <Trademark />
  <India />
  <Hashtags />
</footer>
